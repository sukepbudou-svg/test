...
### 買い目選出方式（強さスコアベース: 2連単2点＋3連単2点）
- **2連単2点**: 強さスコア（ET・ST・モーター2連率・グレード）上位2艇の両方向
  - 例: 1位=3号艇、2位=1号艇 → 3-1 と 1-3 を購入
- **3連単2点**: Pattern B（1着=強さ上位2艇候補 × 2着=3番目強さ × 3着=脅威艇or最下位）
  - 脅威艇: シグナルにA1選手・前付け・ST速のある艇を優先
  - 例: 3-1-5 と 1-3-5
