...
**Track1（逆転狙い）**: PT5〜9 + 1号艇ライブ最安≤8倍（人気集中）
- hero固定（2〜6号艇）で中穴2点（20〜50倍・動態スコア）+ 大穴1点（80倍超・波乱スコア）

**Track2（万舟狙い）**: PT7〜9 + 1号艇ライブ>8倍 or ライブ未取得
- hero固定なし。全120点から80倍超の組み合わせを全艇波乱スコアで上位3点選出

**見送り**: PT≤4 / PT5〜6かつ1号艇>8倍 / Track2でも80倍超なし → データ収集のみ
